...
if (isset($_GET['q'])) {
    $query = $_GET['q'];
    $products = buscarProdutos($query); // Implemente a função buscarProdutos para filtrar os resultados com base na consulta
} else {
    // Verifica o tipo de ordenação selecionada (preço menor, preço maior, mais recente, mais antigo)
    if (isset($_GET['order'])) {
        $order = $_GET['order'];
        switch ($order) {
            case 'preco_menor':
                $products = listarTabela("id, nome, descricao, preco, imagem", 'produto', 'preco ASC');
                break;
            case 'preco_maior':
                $products = listarTabela("id, nome, descricao, preco, imagem", 'produto', 'preco DESC');
                break;
            case 'recentes':
                $products = listarTabela("id, nome, descricao, preco, imagem", 'produto', 'id DESC');
                break;
            case 'antigos':
                $products = listarTabela("id, nome, descricao, preco, imagem", 'produto', 'id ASC');
                break;
            default:
...
<body>
    ...
    <div class="container altContainer">
        <!-- Pesquisa -->
        <form class="d-flex mt-4" action="index.php" method="GET" role="search">
            <a class="iconeCarrinho" href="index.php"><i class="bi bi-cart4"></i></a>
        ...
        <div class="row mt-3">
            <div class="col">
                ...
                <ul class="list-inline">
                    <li class="list-inline-item"><a href="index.php?order=preco_menor" class="link-secondary">Preço
                            menor</a></li>
                    <li class="list-inline-item"><a href="index.php?order=preco_maior" class="link-secondary">Preço
                            maior</a></li>
                    <li class="list-inline-item"><a href="index.php?order=recentes" class="link-secondary">Mais
                            recentes</a></li>
                    <li class="list-inline-item"><a href="index.php?order=antigos" class="link-secondary">Mais
                            antigos</a></li>
                </ul>
            </div>
        </div>
        ...
        <div class="row mb-3">
            <?php foreach ($products as $product) { ?>
                <div class="col-lg-3 col-md-6 mt-3 col-sm-6 col-6">
                    <div class="cardH">
                        <img src="./img/<?php echo $product->imagem; ?>" class="card-img-top img-fluid product-img"
                            alt="...">
                        <div class="card-body">
