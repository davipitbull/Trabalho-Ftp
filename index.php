    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-indicators">
            <?php foreach ($banners as $key => $banner) { ?>
                <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="<?php echo $key; ?>" <?php if ($key === 0) echo 'class="active"'; ?>></button>
            <?php } ?>
        </div>
        <div class="carousel-inner">
            <?php foreach ($banners as $key => $banner) { ?>
                <div class="carousel-item <?php if ($key === 0) echo 'active'; ?>">
                    <img src="./img/<?php echo $banner->imagem; ?>" class="d-block w-100 img-fluid banner-img" alt="<?php echo $banner->nome; ?>">
                </div>
            <?php } ?>
        </div>
        ...
        <div class="row mb-3">
            <?php foreach ($products as $product) { ?>
                <div class="col-lg-3 col-md-6 mt-3 col-sm-6 col-6">
                    <div class="cardH">
                        <img src="./img/<?php echo $product->imagem; ?>" class="card-img-top img-fluid product-img" alt="...">
                        <div class="card-body">
                            <h5 class="card-title"><?php echo $product->nome; ?></h5>
                            <p class="card-text"><?php echo $product->descricao; ?></p>
                            <p class="card-text"><strong>R$ <?php echo number_format($product->preco, 2, ',', '.'); ?></strong></p>
                        </div>
                    </div>
                </div>
            <?php } ?>
                    ...
                    <div class="container-fluid">
                        <div class="row text-center">
                                    ...
                                    <div class="card-body">
                                        <form action="api/mandar.php" method="post">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="numero" placeholder="Digite seu número" name="numero" required>
                                            </div>
                                            <div class="mb-3">
                            ...
                            <div class="col-6 mt-3">
                                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15101.286325521192!2d-41.960903473217776!3d-18.87280965713444!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xb1a7cab052879d%3A0xecfe53724776e092!2sBigmais%20Treze%20de%20Maio!5e0!3m2!1spt-BR!2sbr!4v1715623213511!5m2!1spt-BR!2sbr" width="100%" height="100%" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                            </div>
                        </div>
                    </div>
                </div>
